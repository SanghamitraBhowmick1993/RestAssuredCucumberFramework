...
public class Set2B_3 extends CommonUtility {
	...
	public void testMethod() throws Exception {
		...
		//clicking on color dropdown and selecting Black
		performMoveToElementAction("(//p[.='Filter By']//parent::div//div//div)[1]");
		Thread.sleep(1000);
		clickWebElement("//label[contains(@for,'Black')]");
		Thread.sleep(2000);
		
		//Check if first product displayed has Black in it
		...
		Assert.assertTrue(productName.toLowerCase().contains("black"));
				
		//Checking if Black is present in Applied filters
		Boolean flag = false;
